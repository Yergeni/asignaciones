...
namespace CURSO\UserBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="CURSO\UserBundle\Repository\UserRepository")
...
class User implements UserInterface, EncoderAwareInterface
{
     ...
     * @Assert\NotBlank()
     * @Assert\Choice(choices = {"ROLE_ADMIN", "ROLE_USER"}, message = "Choose a Role.")
     */
    private $role;
    ...
    //Implementacion de los eventos de lifecyclecallback
    /**
     * @ORM\PrePersist
     */
